...
namespace ClientExtranet
{
    class Program
    {
        static void Main(string[] args)
        {
            VelibService.VelibServiceClient velibClient = new VelibService.VelibServiceClient("extranet");
            string shouldContinue = "yes";

            while (shouldContinue.ToLower().Equals("yes") || shouldContinue.ToLower().Equals("y"))
            {
                InteractWithUser(velibClient);
        ...
        private static void InteractWithUser(VelibService.VelibServiceClient velibClient)
        {
            ...
            string departure_coords = velibClient.GetCoords(departure_address);
            ...
            string arrival_coords = velibClient.GetCoords(arrival_address);
            ...
            Console.WriteLine(velibClient.GetItinerary(departure_coords, arrival_coords));
